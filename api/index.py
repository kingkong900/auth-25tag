...
class GameInfo:
    def __init__(self):
        self.TitleId: str = "" # 19779E
        self.SecretKey: str = "" # 
RBRQCMZM63YR446K8X5RP13QNWR68HJEQZQ1KI8M6Z8PGSEWDW
        self.ApiKey: str = "" # OC|1198321793360924|3504e8deb41150efa3dff8fdb4deb8c4
...
def titledata():
    response_data = {
        ...
        "MOTD": "<color=red>WELCOME TO GOTTO!</color>\n<color=yellow>OWNER IS JACOBSHORTS</color>\n<color=lime>DEVELOPER IS JACOBSHORTS</color>\n<color=blue></color>",
        "SeasonalStoreBoardSign": "<color=red>RATE THE GAME 5 STARS!</color>\n<color=blue>.GG/UNLOADTAG</color>",
        "TOS_2024.09.20": "",
        "TOBAlreadyOwnCompTxt": "",
        "TOBAlreadyOwnPurchaseBundle": "",
        "TOBDefCompTxt": "DISCORD.",
        "TOBDefPurchaseBtnDefTxt": "",
        "UseLegacyIAP": False
